...
public class AliyunDmsResultSet1 implements ResultSet {
    ...
    /**
     * 按列索引获取原始值，同时更新 lastReadWasNull。
     */
    private Object rawValue(int columnIndex) throws SQLException {
        Object val = currentRow().get(resolveColumnName(columnIndex));
        lastReadWasNull = (val == null);
        return val;
    }

    /**
     * 按列名获取原始值，同时更新 lastReadWasNull。
     */
    ...
    private String resolveColumnName(int columnIndex) throws SQLException {
    ...
    public String getString(int columnIndex) throws SQLException {
        Object val = rawValue(columnIndex);
        return val != null ? val.toString() : null;
    }

    @Override
    public String getString(String columnLabel) throws SQLException {
        Object val = rawValue(columnLabel);
        return val != null ? val.toString() : null;
    }
    ...
    public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
        if (type == null) { throw new SQLException("Type cannot be null"); }
